...
export const DB_ECOMMERCE_PATH_ENTITIES = `${dir}/infra/database/e-commerce/schemas/*.{ts,js}`
...
export const DB_DASHBOARD_PATH_ENTITIES = `${dir}/infra/database/e-commerce/schemas/*.{ts,js}`
