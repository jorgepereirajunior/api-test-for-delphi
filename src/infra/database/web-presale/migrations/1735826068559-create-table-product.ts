  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`ap_product\` (
        ...
        \`vlVarejo\` decimal(10,2) NOT NULL, 
        \`vlAtacado\` decimal(10,2) NOT NULL, 
        ...
        \`vlVarejoPromocao\` decimal(10,2) NULL, 
        \`vlAtacadoPromocao\` decimal(10,2) NULL, 
        ...
        \`vlVarejoMinimo\` decimal(10,2) NOT NULL, 
        \`vlVarejoMaximo\` decimal(10,2) NOT NULL, 
        \`vlAtacadoMinimo\` decimal(10,2) NOT NULL, 
        \`vlAtacadoMaximo\` decimal(10,2) NOT NULL, 
